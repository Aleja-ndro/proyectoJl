...
const handleModificarProducto = async (datosActualizados) => {
  ...
  return (
    ...
    className="flex-1 min-w-[120px] sm:flex-none bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg flex items-center justify-center gap-1 sm:gap-2 text-sm sm:text-base transition-colors"
  >
  ...
  <button
    ...
    className={`flex-1 min-w-[120px] sm:flex-none px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg flex items-center justify-center gap-1 sm:gap-2 text-sm sm:text-base transition-colors ${
  ...
  <button
    ...
    className="flex-1 min-w-[120px] sm:flex-none bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg flex items-center justify-center gap-1 sm:gap-2 text-sm sm:text-base transition-colors"
  >
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5" viewBox="0 0 20 20" fill="currentColor">
